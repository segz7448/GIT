...
// screen is open. This is a foreground-only loop - see backgroundTasks.ts
            ...
            <View style={styles.card}>
              <TouchableOpacity onPress={() => handleOpen(item)}>
                ...
                {(item.git_status?.has_uncommitted_changes || item.git_status?.has_unpushed_changes) && (
                  <View style={styles.uncommittedRow}>
                    <PremiumIcon name="warning" size={12} color={colors.warning} />

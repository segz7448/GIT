      ...
      <View style={styles.runHeader}>
        ...
        <View style={styles.runHeaderActions}>
          {run.status !== 'completed' && (
            <TouchableOpacity onPress={handleToggleWatch} style={[styles.headerActionButton, styles.watchButton]}>
              <PremiumIcon
                name={isWatched ? 'bell' : 'bellOff'}
                size={14}
                color={isWatched ? colors.accent : colors.fgMuted}
                active={isWatched}
              />
              <Text style={[styles.headerActionText, styles.watchButtonText]}>
...
const styles = StyleSheet.create({
  ...
  watchButton: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  ...
  liveText: { color: colors.danger, fontSize: typography.sizeSm, fontWeight: '700' },

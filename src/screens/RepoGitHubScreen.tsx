  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: spacing.md }}>
      ...
      <TouchableOpacity style={styles.row} onPress={() => navigation.navigate('RepoIssues', { owner, repo })}>
        ...
        <PremiumIcon name="chevronRight" size={16} color={colors.fgSubtle} />
      </TouchableOpacity>
      <TouchableOpacity
        style={styles.row}
      ...
      <TouchableOpacity style={styles.row} onPress={handleToggleStar} disabled={starLoading || starred === null}>
        {starLoading || starred === null ? (
          ...
          <View style={styles.starRow}>
            <PremiumIcon name="star" size={16} active={!!starred} color={colors.fgMuted} activeColor={colors.warning} />
